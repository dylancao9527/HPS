...
CREATE TABLE `prediction_records`  (
  ...
  `cache_mode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `has_anomaly` tinyint(1) NOT NULL,
...
CREATE TABLE `user_prophet_models`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `ix_user_prophet_models_active_slot_trained`(`user_id` ASC, `is_active` ASC, `trained_at` ASC, `id` ASC) USING BTREE,
